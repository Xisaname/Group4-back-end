...
def train(hyp):
    cfg = opt.cfg
    data = opt.data
    epochs = opt.epochs  # 500200 batches at bs 64, 117263 faceMask = 273 epochs
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=300)  # 500200 batches at bs 16, 117263 COCO faceMask = 273 epochs
    ...
    parser.add_argument('--cache-faceMask', action='store_true', help='cache faceMask for faster training')
